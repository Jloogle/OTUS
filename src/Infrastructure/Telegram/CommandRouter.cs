...
public class CommandRouter : ICommandRouting
{
    ...
    private void RegisterRoutes(IEnumerable<object> handlers)
    {
        foreach (var handler in handlers)
        {
            ...
            RegisterRoute<EditProjectCommand>(handler, BotCommands.ProjectEdit);
            ...
            RegisterRoute<TaskCreateCommand>(handler, BotCommands.TaskCreate);
            // RegisterRoute<ChangeTaskCommand>(handler, BotCommands.ChangeTask);
            RegisterRoute<ListMyTasksCommand>(handler, BotCommands.ListMyTasks);
            RegisterRoute<TaskAssignCommand>(handler, BotCommands.TaskAssign);
            RegisterRoute<TaskSetDeadlineCommand>(handler, BotCommands.TaskDeadline);
            RegisterRoute<AcceptTaskInviteCommand>(handler, BotCommands.AcceptTask);
            RegisterRoute<DeclineTaskInviteCommand>(handler, BotCommands.DeclineTask);
