    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationProjTask", x => new { x.NotificationId, x.TasksId });
                    table.ForeignKey(
                        name: "FK_NotificationProjTask_Notifications_NotificationId",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotificationProjTask_Tasks_TasksId",
                        column: x => x.TasksId,
                        principalSchema: "OTUS",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationProjTask_TasksId",
                schema: "OTUS",
                table: "NotificationProjTask",
                column: "TasksId");
