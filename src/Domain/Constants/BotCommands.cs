...
public static class BotCommands
{
    ...
    [Commands("Редактирование проекта - /project_edit [ID] [название] [дедлайн].")]
    ...
    [Commands("Назначить задачу пользователю проекта - /task_assign [ID задачи] [email]")]
    public const string TaskAssign = "/task_assign";

    [Commands("Создание задачи - /task_create [название] [описание] [ID проекта] [дедлайн?]. Дедлайн в формате [ГГГГ-ММ-ДД ЧЧ:ММ]")]
    public const string TaskCreate = "/task_create";

    [Commands("Установить дедлайн задачи - /task_deadline [ID задачи] [дата/время]")]
    public const string TaskDeadline = "/task_deadline";

    [Commands("Принять приглашение на задачу - /accept_task [ID]")]
    public const string AcceptTask = "/accept_task";

    [Commands("Отклонить приглашение на задачу - /decline_task [ID]")]
    public const string DeclineTask = "/decline_task";
